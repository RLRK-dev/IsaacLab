...
FORCE_L_HIGH_THRESHOLD = 50.0    # N - Reduce velocity when Force L exceeds this (H195: 50.0→30.0)
FORCE_L_LOW_THRESHOLD = 30.0     # N - Restore velocity when Force L drops below this
FORCE_L_REDUCED_VELOCITY = 0.30  # rad/s - Reduced velocity (H195: 0.30→0.15, more conservative)
...
H193_LEFT_FOLLOW_RATIO = 0.4           # Left arm follows 40% of right arm X movement (H195: 0.6→0.4)
