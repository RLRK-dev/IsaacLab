...
- **⚠ 2026-08-08 — ASSET-REFERENCE SUPERSEDED (Rs 裁定 item-5・p4 記録):** the authoritative committed asset for the locked コ geometry is now **`_ur15_2f85_koshape_actuated.xml`** (opening **16.00 mm** / centre 31.00 / sha256 `01861b95e9c8413c…`; aperture history 10.00→14.00→16.00; the 14→16 step = Rs-directed verbatim 2026-07-28「青い爪（コの上側）を2mmうえに移動」, implemented `1a1efe0ac5`). `2f85_koshape.xml` (10.00) = banked historical LOCK, retained **unedited** (Rs 2026-07-21 freeze-form). Geometry numbers below derived from the 10.00-era asset are historical, not current. ⚠ **record ≠ wiring**: `test_newton_clip_routing.py:160` still loads `2f85_koshape.xml` (live-but-degraded per p18/p6 2026-08-08; repointing = separate, unruled work). ⚠ **RS71 §0#4 の参照はこの記録に未追随** — 04-Specs 書込が Rs 委任の射程内かは Rs 照会中（p18 m-p18-62 gate）・prepared patch = `eval_runs/troot_optE_dapg_wholeroute_scope_20260701/ITEM5_SPEC_LANDING_PREPARED_RS71_PATCH_20260808.patch`。→ ✅ **RESOLVED 2026-08-08 10:12**: Rs「a」（labelled A/B/C への回答・解決者 p4）で書込認可 → **RS71 landed @ `13a1331fc0`**（:26 最小節＋§0-A 詳細形・LOCK asset 不触）。Ruling custody = `eval_runs/troot_optE_dapg_wholeroute_scope_20260701/ITEM5_RS_RULING_WORKING_ASSET_AUTHORITATIVE_20260808.md` @ `b01247e485`.
