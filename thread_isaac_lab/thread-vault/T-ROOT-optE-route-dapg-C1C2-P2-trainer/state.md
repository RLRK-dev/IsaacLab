...
- 現況 (13:51): W1 charter v0.1 DRAFT + envbuild 子 node spawn 済。p1 verify PENDING → PASS 後 %11 B1+ 解禁 (B0 は即時可)。campaign は HIGH-COST + production-launch + fresh Rs GO 背後 (不変)。
