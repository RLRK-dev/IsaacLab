...
- 現況 (17:50): B0 ✓ / **B1 CLOSE ✓** (e1eac1deb8 + 追補 04a31e1e98、3-leg joint) / **現 = B2 (HOLD + oracle API) L3 chain (%11 build 中)** / B3-B7 残。
