...
last_updated: 2026-09-20T08:48:13+09:00
...
| # | 成果物 | 担当 | pointer（p6 09-20 08:48 実測・HEAD `c5f72b1e9a`・初版 17:58 @ `dc090f7753`） |
|---|---|---|---|
| ① | 設計 v3 `eval_runs/troot_optE_dapg_wholeroute_scope_20260701/P11_UR15B_CONTROLLER_DESIGN_20260913.md` | p11 | 最新 `7427c1764c`（09-20 08:23・§17.7 = R0 targets の出所 = 生成 cell の rest を link-centre 形で・267 行・§17.6 = `2743fc4549`・初版 §17 = `dc090f7753`）。「未検証」の札は v3 `:1` のまま |
