...
last_updated: 2026-09-20T11:11:29+09:00
...
| # | 成果物 | 担当 | pointer（p6 09-20 11:11 実測・HEAD `231d7d88ba`・初版 17:58 @ `dc090f7753`） |
|---|---|---|---|
| ① | 設計 v3 `eval_runs/troot_optE_dapg_wholeroute_scope_20260701/P11_UR15B_CONTROLLER_DESIGN_20260913.md` | p11 | 最新 `ebbe062874`（09-20 11:07:36・§17.11 = 窓 R0 受入の記録〔運ぶ主張 = 収束のみ＋鏡像同一性・「未検証」印 `:1` は残す〕・290 行・§17.10 = `ded9c8ee30`〔R0-ii 149 対の読み・menu の attitude 意味論・17.8 (b) 予測の挿入訂正〕・§17.9 = `20281bbf83`・§17.8 = `e0b2857a50`〔§10 撤回・R0-ii 採用〕・§17.7 = `7427c1764c`・§17.6 = `2743fc4549`・初版 §17 = `dc090f7753`）。「未検証」の札は v3 `:1` のまま |
...
| ⑦ | まとめ・受入 | p4 | 未（着手 ≠ 受入・Rs1 補足 b）・宣言前に要るもの（p4 09-20 item 22/24）= ⑤ R1/R1′/R2・計器窓（DDR 73）・report 行の受入（「内側」なら p11 court の判断が先） |
