...
last_updated: 2026-09-20T08:50:09+09:00
...
| # | 成果物 | 担当 | pointer（p6 09-20 08:50 実測・HEAD `aeee14db72`・初版 17:58 @ `dc090f7753`） |
|---|---|---|---|
| ① | 設計 v3 `eval_runs/troot_optE_dapg_wholeroute_scope_20260701/P11_UR15B_CONTROLLER_DESIGN_20260913.md` | p11 | 最新 `e0b2857a50`（09-20 08:46・§17.8 = §10 R0 行の撤回＋R0-ii 採用・273 行・§17.7 = `7427c1764c`・§17.6 = `2743fc4549`・初版 §17 = `dc090f7753`）。「未検証」の札は v3 `:1` のまま |
