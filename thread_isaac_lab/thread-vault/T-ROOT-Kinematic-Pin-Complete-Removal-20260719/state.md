...
last_updated: 2026-09-20T09:54:47+09:00
...
| # | 成果物 | 担当 | pointer（p6 09-20 09:54 実測・HEAD `62d6c69bd5`・初版 17:58 @ `dc090f7753`） |
|---|---|---|---|
| ① | 設計 v3 `eval_runs/troot_optE_dapg_wholeroute_scope_20260701/P11_UR15B_CONTROLLER_DESIGN_20260913.md` | p11 | 最新 `ded9c8ee30`（09-20 09:37・§17.10 = R0-ii 149 対の読み〔menu の attitude 意味論・17.8 (b) 予測の挿入訂正〕・285 行・§17.9 = `20281bbf83`・§17.8 = `e0b2857a50`〔§10 撤回・R0-ii 採用〕・§17.7 = `7427c1764c`・§17.6 = `2743fc4549`・初版 §17 = `dc090f7753`）。「未検証」の札は v3 `:1` のまま |
