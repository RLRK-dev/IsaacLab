...
last_updated: 2026-09-20T11:26:39+09:00
...
| # | 成果物 | 担当 | pointer（p6 09-20 11:26 実測・HEAD `1dfa696c07`・初版 17:58 @ `dc090f7753`） |
|---|---|---|---|
| ① | 設計 v3 `eval_runs/troot_optE_dapg_wholeroute_scope_20260701/P11_UR15B_CONTROLLER_DESIGN_20260913.md` | p11 | 最新 `8d9fdf3bbb`（09-20 11:24:02・§17.13 = 引用行の挿入訂正〔hub RETURN §1554 の受入・17.10/17.12 の式・仕様・予測は不変〕・319 行・§17.12 = `40aa696587`〔R0-iii 手首方向 report 行の仕様・body file:line・符号規約・B/RC/NH の予測・反証形・⚠ p4 の語「§17.11」= 17.12〕・§17.11 = `ebbe062874`〔窓 R0 受入の記録・「未検証」印 `:1` は残す〕・§17.10 = `ded9c8ee30`〔R0-ii 149 対の読み・menu の attitude 意味論・17.8 (b) 予測の挿入訂正〕・§17.9 = `20281bbf83`・§17.8 = `e0b2857a50`〔§10 撤回・R0-ii 採用〕・§17.7 = `7427c1764c`・§17.6 = `2743fc4549`・初版 §17 = `dc090f7753`）。「未検証」の札は v3 `:1` のまま |
