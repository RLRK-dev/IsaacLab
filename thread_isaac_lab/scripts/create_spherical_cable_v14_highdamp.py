#!/usr/bin/env python3
"""
Create SphericalJoint Cable USD v14 - High Damping (NaN Prevention)
====================================================================

v14: High damping version to prevent speed spike and NaN
- Based on v9_mid (100g/seg, coneAngle=30°)
- Increased damping: 20.0 → 40.0

Hypothesis: Higher damping will dissipate energy faster, preventing
the speed spike that leads to NaN at ~7cm lift.
"""

import argparse
from isaaclab.app import AppLauncher

parser = argparse.ArgumentParser(description="Create SphericalJoint Cable USD v14")
...
# v14: Same mass as v9_mid, but higher damping
...
# HIGH DAMPING - key change for v14
LINEAR_DAMPING = 40.0   # Doubled from v9_mid (20.0)
ANGULAR_DAMPING = 40.0  # Doubled from v9_mid (20.0)

OUTPUT_PATH = "/home/rlrk/IsaacLab/source/extensions/isaaclab_tasks_thread/data/cable/spherical_cable_v14_highdamp.usd"


def create_cable_usd(output_path: str):
    """Create a high-damping cable USD to prevent NaN."""

    print("=" * 60)
    print("Creating SphericalJoint Cable USD v14 (High Damping)")
    print("=" * 60)
    ...
    print(f"  Linear damping: {LINEAR_DAMPING} (DOUBLED from v9_mid)")
    print(f"  Angular damping: {ANGULAR_DAMPING} (DOUBLED from v9_mid)")
    ...
    for i in range(NUM_SEGMENTS):
        ...
        # Orange color for v14 (high damping)
        capsule.GetDisplayColorAttr().Set([(1.0, 0.5, 0.2)])
