#!/usr/bin/env python3
"""
Create SphericalJoint Cable USD v7 - Ultra Stable
==================================================

v7: Maximum stability for arm teleport scenarios
- Very high linear/angular damping (50.0)
- Smaller cone angle limit (15°) for stiffer cable
- Higher mass for inertia
- Maximum solver iterations

Purpose: Prevent cable NaN when arm teleports.
"""

import argparse
from isaaclab.app import AppLauncher

parser = argparse.ArgumentParser(description="Create SphericalJoint Cable USD v7")
...
# Cable parameters - optimized for stability
NUM_SEGMENTS = 20
SEGMENT_LENGTH = 0.03  # 3cm per segment
SEGMENT_RADIUS = 0.005  # 5mm radius
TOTAL_LENGTH = NUM_SEGMENTS * SEGMENT_LENGTH  # 60cm total

# v7: Ultra-high stability parameters
SEGMENT_MASS = 0.1  # 100g per segment (heavier for inertia)
CONE_ANGLE_LIMIT = 15.0  # degrees (stiffer cable)
SOLVER_POS_ITER = 128  # Maximum solver iterations
SOLVER_VEL_ITER = 32
LINEAR_DAMPING = 50.0  # Very high linear damping
ANGULAR_DAMPING = 50.0  # Very high angular damping

OUTPUT_PATH = "/home/rlrk/IsaacLab/source/extensions/isaaclab_tasks_thread/data/cable/spherical_cable_v7_stable.usd"


def create_cable_usd(output_path: str):
    """Create a highly stable cable USD."""

    print("=" * 60)
    print("Creating SphericalJoint Cable USD v7 (Ultra Stable)")
    print("=" * 60)
