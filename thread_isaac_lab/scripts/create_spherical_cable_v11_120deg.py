#!/usr/bin/env python3
"""
Create SphericalJoint Cable USD v11 - 120 degree cone angle
==========================================================

v11: Maximum flexibility for extreme lift testing
- Same damping as v9 (20.0)
- Very high cone angle limit (120°) to allow extreme bending
"""

import argparse
from isaaclab.app import AppLauncher

parser = argparse.ArgumentParser(description="Create SphericalJoint Cable USD v11")
...
# v11: 120 degree parameters
SEGMENT_MASS = 0.1  # 100g per segment
CONE_ANGLE_LIMIT = 120.0  # degrees - MAXIMUM FLEXIBILITY
SOLVER_POS_ITER = 128
SOLVER_VEL_ITER = 32
LINEAR_DAMPING = 20.0
ANGULAR_DAMPING = 20.0

OUTPUT_PATH = "/home/rlrk/IsaacLab/source/extensions/isaaclab_tasks_thread/data/cable/spherical_cable_v11_120deg.usd"


def create_cable_usd(output_path: str):
    """Create a maximum-flexibility cable USD with 120° cone angle."""

    print("=" * 60)
    print("Creating SphericalJoint Cable USD v11 (120° Cone Angle)")
    print("=" * 60)
    ...
    for i in range(NUM_SEGMENTS):
        ...
        # Red color for v11 (120°)
        capsule.GetDisplayColorAttr().Set([(1.0, 0.2, 0.2)])
