...
def hold_position(num_steps: int = 50) -> None:
    """Hold current position for stabilization (v53).

    Run simulation steps while keeping robot joints at their current positions.
    This allows the cable physics to settle after movement.

    Args:
        num_steps: Number of simulation steps to hold.
    """
...
def run_cycle(cycle_idx: int):
    ...
    # v54b: Both arms X reduced for better balance and reachability
    p45b_target_l = torch.tensor([[0.36, p4_pos_l[0,1].item(), PRE_ROTATION_Z]], device=device)
    p45b_target_r = torch.tensor([[0.35, p4_pos_r[0,1].item(), PRE_ROTATION_Z]], device=device)
    ...
    # v53: Stabilization hold after Stage 1b
    print("  [P4.5 Stage1b] Holding for stabilization (50 steps)...")
    hold_position(50)
    ...
    # v53: Stabilization hold after Stage 1c
    print("  [P4.5 Stage1c] Holding for stabilization (50 steps)...")
    hold_position(50)
    ...
    # v53: Stabilization hold after Stage 2a
    print("  [P4.5 Stage2a] Holding for stabilization (50 steps)...")
    hold_position(50)
