...
def run_arc_rotation_with_collection(
    ...
    for i in range(num_steps):
        ...
        JOINT_DELTA_MAX = 0.02  # v52a: 0.02rad + steps=2000
...
def run_cycle(cycle_idx: int):
    ...
    PHASE45B_X_STEPS = 2000  # v52a: 500→2000
    ...
    PHASE45C_Y_STEPS = 2000  # v52a: 500→2000
    ...
    STAGE2A_STEPS = 2000  # v52a: 300→2000
    ...
    STAGE2B_STEPS = 2000  # v52a: 400→2000
