...
# =============================================================================
# LEFT ARM ONLY TEST MODE
# Right arm stays at initial position (no grasping)
# Purpose: Isolate left arm physics for NaN debugging
# =============================================================================
LEFT_ONLY_MODE = True
...
def set_right_arm(robot_right, arm_joints, gripper_val):
    """Set right arm joints, respecting LEFT_ONLY_MODE."""
    if LEFT_ONLY_MODE:
        # Keep right arm at initial position with gripper open
