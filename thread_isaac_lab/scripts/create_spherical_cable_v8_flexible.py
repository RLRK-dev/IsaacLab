#!/usr/bin/env python3
"""
Create SphericalJoint Cable USD v8 - Flexible
==============================================

v8: Higher flexibility for natural cable behavior
- Lower linear/angular damping (5.0)
- Larger cone angle limit (45°) for flexible cable
- Same mass as v7 for comparison
"""

import argparse
from isaaclab.app import AppLauncher

parser = argparse.ArgumentParser(description="Create SphericalJoint Cable USD v8")
...
# v8: Flexible parameters
SEGMENT_MASS = 0.1  # 100g per segment (same as v7)
CONE_ANGLE_LIMIT = 45.0  # degrees (more flexible)
SOLVER_POS_ITER = 128  # Keep high solver iterations
SOLVER_VEL_ITER = 32
LINEAR_DAMPING = 5.0  # Lower damping for flexibility
ANGULAR_DAMPING = 5.0  # Lower damping for flexibility

OUTPUT_PATH = "/home/rlrk/IsaacLab/source/extensions/isaaclab_tasks_thread/data/cable/spherical_cable_v8_flexible.usd"


def create_cable_usd(output_path: str):
    """Create a flexible cable USD."""

    print("=" * 60)
    print("Creating SphericalJoint Cable USD v8 (Flexible)")
    print("=" * 60)
    ...
    for i in range(NUM_SEGMENTS):
        ...
        # Green color for v8 flexible
        capsule.GetDisplayColorAttr().Set([(0.2, 0.8, 0.3)])
