#!/usr/bin/env python3
"""
Create SphericalJoint Cable USD v10 - High Damping
===================================================

v10: Same as v9 but with 2x damping to prevent NaN at Phase 4.5 end
- High linear/angular damping (40.0) - doubled from v9
- Same cone angle limit (30°)
- Same mass as v9
"""
...
parser = argparse.ArgumentParser(description="Create SphericalJoint Cable USD v10")
...
# v10: High damping parameters (2x of v9)
SEGMENT_MASS = 0.1  # 100g per segment (same as v9)
CONE_ANGLE_LIMIT = 30.0  # degrees (same as v9)
SOLVER_POS_ITER = 128  # Keep high solver iterations
SOLVER_VEL_ITER = 32
LINEAR_DAMPING = 40.0  # 2x v9 (was 20.0)
ANGULAR_DAMPING = 40.0  # 2x v9 (was 20.0)

OUTPUT_PATH = "/home/rlrk/IsaacLab/source/extensions/isaaclab_tasks_thread/data/cable/spherical_cable_v10_high_damp.usd"


def create_cable_usd(output_path: str):
    """Create a high damping cable USD."""

    print("=" * 60)
    print("Creating SphericalJoint Cable USD v10 (High Damping)")
    print("=" * 60)
    ...
    print(f"  Linear damping: {LINEAR_DAMPING} (2x v9)")
    print(f"  Angular damping: {ANGULAR_DAMPING} (2x v9)")
    ...
    for i in range(NUM_SEGMENTS):
        ...
        # Orange color for v10 high damp
