#!/usr/bin/env python3
"""
Create SphericalJoint Cable USD v10 - 90 degree cone angle
==========================================================

v10: High flexibility for 10cm+ lift testing
- Same damping as v9 (20.0)
- Increased cone angle limit (90°) to prevent joint limit violations
"""
...
OUTPUT_PATH = "/home/rlrk/IsaacLab/source/extensions/isaaclab_tasks_thread/data/cable/spherical_cable_v10_90deg.usd"


def create_cable_usd(output_path: str):
    """Create a high-flexibility cable USD with 90° cone angle."""

    print("=" * 60)
    print("Creating SphericalJoint Cable USD v10 (90° Cone Angle)")
    print("=" * 60)
