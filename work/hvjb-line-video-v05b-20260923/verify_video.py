...
STEM = "HVJB_line_split_process_concept_v05b_review"
...
def main() -> None:
    ...
    plan = json.loads((ROOT / "data/concept_v05b.json").read_text())
    ...
    assert encoded["presentation_sha256"] == sha(ROOT / "data/concept_v05b.json")
    ...
    for number, (index, scene) in enumerate(zip(indices, selected_scenes, strict=True), start=1):
        ...
        source = ROOT / "previews/concept_v05b" / manifest["images"][index]["file"]
