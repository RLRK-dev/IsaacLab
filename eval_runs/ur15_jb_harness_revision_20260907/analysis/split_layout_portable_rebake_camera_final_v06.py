...
PINNED_NATIVE = "e65bef607c1d29671fc982d14d72d4c2694420edd284378cb2f1445f18f354ed"
PINNED_AUDIT = "94131bdf7cd66352b3065d2402af649a589baceec75ebb0f24b837ae6b27e8c5"
...
def main():
    destination = ROOT / "analysis/op030_split_portable_rebake_camera_final_v06.blend"
    report_path = ROOT / "audit/op030_split_layout_portable_rebake_camera_final_v06.json"
    log_path = ROOT / "audit/op030_split_layout_portable_rebake_camera_final_v06.log"
    readback_path = ROOT / "audit/op030_split_layout_portable_rebake_native_camera_final_v06.json"
    ...
    build_log = ROOT / "audit/op030_split_bake_camera_final_v06.log"
    ...
    with tempfile.TemporaryDirectory(prefix="op030_split_portable_rebake_") as directory:
        ...
        report = dict(
            ...
            supersedes=dict(
                report="audit/op030_split_layout_portable_rebake_before_camera_v06.json",
                sha256="5993ad236a7067897dae996494bc71d1430cdd4632c65ba324da330329a5ad5f",
                reason=(
                    "Accepted changes to only two presentation camera poses/lenses; "
                    "saved motion and static geometry unchanged"
                ),
                preserved_native="analysis/op030_split_portable_rebake_v06.blend",
            ),
