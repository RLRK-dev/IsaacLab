...
const directory='/home/rlrk/Downloads/THREAD_HVJB_写真部品照合_v01_20260915';
...
try{
  ...
  const report={checked_at:new Date().toISOString(),initial,selected,content,mobile,missing_links:missing,
  ...
  await writeFile(fileURLToPath(new URL('../audit/hvjb_photo_browser_v01.json',import.meta.url)),text);
