# WMSO D1.1-A `contracts_v2` — DESIGN (v2.7.1)

- node: `T-WMSO`; author = w2:pQ (RS-TECH-LEAD2)
- created: v1 = 2026-07-19 09:09 JST / v1.1 = 09:24 / v2 = 09:32 / v2.1 = 09:43 / v2.2 = 10:59（editing 完了実測; 旧「10:5x」表記を確定 — 以後 x-mask 廃止）/ v2.3 = 12:07 / v2.4 = 12:41（12:31 に v2.3.1 として着手後、Rs review v3 着信により拡張）/ v2.4.1 = 13:07 / v2.5 = 13:36 / v2.6 = 14:16 / v2.7 = 14:36 / **v2.7.1 = 15:46 JST（実測; records-only — pN transcript 著者 readback CONFIRMED の反映 2 行のみ・設計内容無変更。pS 照合中の delta につき即時通知）**
