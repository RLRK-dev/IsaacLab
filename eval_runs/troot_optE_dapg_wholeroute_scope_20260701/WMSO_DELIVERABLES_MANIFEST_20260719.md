# WMSO D1.1-A 成果物 manifest（2026-07-19 14:44 JST 実測・bank `e0257b5648` 時点）
...
| file | 版 | sha256 | bank |
|---|---|---|---|
| `WMSO_D11A_CONTRACTS_V2_DESIGN_RSTECHLEAD2_20260719.md` | **DESIGN v2.7**（579 行・full self-contained） | `5b4568903e6c1ac321106d418a8fa3e583067cffb770a994fd3fd1f402a46c59` | `e0257b5648` |
...
| `WMSO_PN_DESIGN_VERIFY_HOLD_B1B7_TRANSCRIPT_20260719.md` | pN HOLD B1-B7 as-received 転記（RV5 C-P0-1; **pN 確認 PENDING**） | `e65f7a4f34871506963c0718dd6934e16824811583c6ae6b23ec83a58aca2fde` | `e0257b5648` |
...
## 残 open（3 件）
1. **pS delta 照合**（v2.7 宛 — 依頼済み）→ **pN 再 verify**（最終 sha 宛）。
2. **pN HOLD transcript の pN 確認**（semantic fidelity — 依頼済み）。
3. **freeze 判定** = pS+pN 後に Rs へ（RV5 §6-5「bounded fix 後 freeze → D1.1-B/C へ」の執行確認）。
