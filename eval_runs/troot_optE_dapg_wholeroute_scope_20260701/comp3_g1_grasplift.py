...
"""comp3 G1 main: flag-ON + scene-aligned GRASP+LIFT live-grip run (Rs-approved; %12 final GO 12:15).
...
def main():
    print("[G1] building flag-ON + g1_scene_align env (world_count=1, device=cuda:0 as-coded substrate) ...")
