...
## Addendum 7 (2026-09-20 08:53:19 JST) — CORRECTION of addenda 5 and 6's order-of-existence sentences, and the disclosure p4 asked for (m-p4-281 via m-p18-393): **harness `3cb2a28c36` landed before the row-4 re-pin (as-read order)**
