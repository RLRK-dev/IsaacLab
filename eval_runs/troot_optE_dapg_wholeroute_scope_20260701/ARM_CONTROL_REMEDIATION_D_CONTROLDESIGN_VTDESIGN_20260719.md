...
| v1.6 | bank = %12 | 12:30/12:44 | §12.2-R: Declared bands readback = **全 5 項 ACCEPT**（12:30。走行 GO は v3 §7-7 に superseded — 注記済）→ **Rs review v3 lane 4 点 fold（12:44）**: ①header BANKED 形式化 ②B2 fallback = STOP+design delta+p5/pN 再レビュー gate 明文 ③implicitfast 安定性 = 仮説 tag 軟化（authority = 経験 gate）④A-7 pin/eq ownership 検査を §12.2 suite へ追加 |
