...
- **Budget-tension-confirmed (→ (i)-RL):** γ⊥ plateaus at ~1 like (iv) Outcome-B → **conservative-definite** (1 real on-policy iteration under budget failing ⇒ more iterations won't rescue the budget tension) → route to (i)-RL (Rs re-decide, P2-CRITICAL).
